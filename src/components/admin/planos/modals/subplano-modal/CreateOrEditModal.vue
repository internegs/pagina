            ...
            <div class="offcanvas-body">
                <div class="container-fluid row">
                    <div class="col-md-12 text-center mb-3">
                        ...
                        >
                            <b>{{ hasSubplano ? 'Editar' : 'Novo' }} Subplano</b>
                        </h2>
                    </div>
...
export default {
    ...
    emits: ['handle-close-modal', 'refresh-subplanos'],
    ...
    computed: {
        hasSubplano() {
            return this.subplano && Object.keys(this.subplano).length > 0
        },
    },
    ...
    mounted() {
        const offcanvasElement = document.getElementById('add_subplano')
    ...
    methods: {
        async createOrEdit() {
            try {
                ...
                if (!this.hasSubplano) {
                    await Api.post('/subplano_create', {
                        ...
                        dmFsb3JfaW5pY2lhbA: btoa(this.unmaskMoney(this.obj.valor)),
                        ZGVzdGFxdWU: btoa(this.obj.destaque),
                    })

                    confirmMsg = 'Subplano registrado com sucesso'
                } else {
                    await Api.post('/subplano_edit', {
                        Y2xpZW50ZV9pZA: CLIENTE_ID,
                        bm9tZQ: btoa(this.obj.nome),
                        cmVzdW1v: btoa(this.obj.resumo),
                        Y29udGV1ZG8: btoa(this.obj.conteudo),
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Erro',
                    text: 'Erro ao realizar o registro do subplano.',
        ...
        fillForm(obj) {
            this.obj = {
                ...
                resumo: obj.resumo || '',
                valor: obj.valor ? this.maskMoney(obj.valor) : '',
                destaque: obj.destaque || '',
            }

            this.obj.conteudo = obj?.conteudo ? JSON.parse(obj?.conteudo) : ''
        },

        hideModal() {
            const modalElement = document.getElementById('add_subplano')
